...
import 'package:ayurcare/decoction_name.dart';
import 'package:ayurcare/diseases/disease_page.dart';
import 'package:flutter/material.dart';

void main() {
  runApp(const decoction());
}

class decoction extends StatelessWidget {
  const decoction({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 40),
              child: Text(
                  'Hello, You can click on the images you want to know the details.Then we will show a small description on that selected decoction with its recepies and the importance of that decoction.Ayurcare provides facilitates you to know how the above decoctions can be make. '), // Add your text widget here
            ),
          ],
        ),
      ),
            ...
            child: Padding(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const decname()),
                  );
                },
                child: Image.asset(
                  imageUrls[index],
