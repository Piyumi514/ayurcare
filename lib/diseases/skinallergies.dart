...
void main() {
  runApp(const skinallergies());
}

class skinallergies extends StatelessWidget {
  const skinallergies({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text(
                    "Skin allergies refer to allergic reactions that affect the skin, causing symptoms such as itching, redness, swelling, rashes, or hives. These allergic reactions can be triggered by various factors, including certain foods, medications, insect bites, plants, or contact with allergens. In Sri Lanka, Ayurvedic medicine offers several remedies for managing skin allergies.",
