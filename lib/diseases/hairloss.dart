...
void main() {
  runApp(const hairloss());
}

class hairloss extends StatelessWidget {
  const hairloss({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text(
                    "Hair loss, also known as alopecia, is a common condition characterized by the gradual thinning or loss of hair from the scalp or other parts of the body. It can be caused by various factors such as genetics, hormonal changes, nutritional deficiencies, stress, medical conditions, or environmental factors. In Sri Lanka, Ayurvedic medicine offers several remedies for managing hair loss. ",
