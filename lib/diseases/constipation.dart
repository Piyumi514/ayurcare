...
void main() {
  runApp(const constipation());
}

class constipation extends StatelessWidget {
  const constipation({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text(
                        "Constipation is a common digestive issue characterized by infrequent bowel movements, difficulty passing stool, or passing hard, dry stool. It can be caused by various factors, including a low-fiber diet, dehydration, lack of physical activity, certain medications, or underlying health conditions. In Sri Lanka, Ayurvedic medicine offers several remedies for managing constipation.",
