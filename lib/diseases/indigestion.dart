...
void main() {
  runApp(const indigestion());
}

class indigestion extends StatelessWidget {
  const indigestion({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text(
                    "Indigestion, also known as dyspepsia, is a common condition characterized by discomfort or pain in the upper abdomen, often accompanied by bloating, gas, nausea, and sometimes heartburn. It can occur due to various factors such as overeating, eating too quickly, consuming spicy or fatty foods, stress, or underlying gastrointestinal conditions.",
